      ...
      <div className={styles.container}>
        ...
        <section className={styles.frame2}>
          <div>
            ...
            <main>
              <p>
                Immerse yourself in a stress-free planning experience as we orchestrate every
                detail, from concept to execution. Our team ensures your vision is brought to life
          ...
          <div>
            ...
            <main>
              <p>
                ...
                destination weddings guarantees an enchanting experience no matter where you choose
                to say "I do."
              </p>
            </main>
          </div>
